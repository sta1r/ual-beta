...
<!-- Add section name tag -->
    <?php 
	$title = "Fashion Design and Marketing - Wednesdays (Term Time)"; 
	if (!empty($title)) {
...
<div class="header-panel bg-gray-bg">
    <div class="header-wrapper">
  <div class="row">
          <!-- navigation object : Breadcrumbs --><div class="breadcrumbs"><a href="/">University of the Arts London</a><a href="/csm/">Central Saint Martins</a><a href="/csm/courses/">Courses</a><a href="/csm/courses/short-courses/">Short Courses</a><a href="/csm/courses/short-courses/browse-short-courses/">Browse Short Courses</a><a href="/csm/courses/short-courses/browse-short-courses/fashion-and-textiles/">Fashion and Textiles</a><a href="/csm/courses/short-courses/browse-short-courses/fashion-and-textiles/evening-and-weekend/">Evening and Weekend</a><a href="/csm/courses/short-courses/browse-short-courses/fashion-and-textiles/evening-and-weekend/fashion-design/">Fashion Design</a><a href="/csm/courses/short-courses/browse-short-courses/fashion-and-textiles/evening-and-weekend/fashion-design/fashion-design-and-marketing---wednesdays-term-time/">Fashion Design and Marketing - Wednesdays (Term Time)</a></div>
    <div class="page-title">
      <h1><!-- navigation object : Section name -->Fashion Design and Marketing - Wednesdays (Term Time)</h1>
    </div>
  </div>  
    </div>
</div>
...
<!--<div class="content-wrapper">
  <div class="row">
    <div class="d5-d16">
      <h1>Fashion Design and Marketing - Wednesdays (Term Time)</h1>
    </div>
  </div>
  </div>-->
<!-- Add banner here -->
...
if ($shortEnv == TRUE) { 
$test = new ShortCourse('FASHIOXhPz','csm');
$r = $test->returnXml();
$title = $test->title();
$t = $test->dates();
...
$xml = @simplexml_load_string(courseDatesCache('FASHIOXhPz', 'csm'));
...
<footer class="row white-bg hide">
    <div class="footer-wrapper">
        ...
        <ul id="debug">
          ...
          <li>Page created : Fri 30 Aug 2013 10:48:10</li>
          <li>Page modified : Thu 12 Sep 2013 09:25:17</li>
          <?php $i = 0; ?>
          <li>Section id : 46273</li>
      </ul>
        <!-- end debug -->
    </div>
