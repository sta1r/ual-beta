...
<!-- Add section name tag -->
    ...
    <meta name="description" content="Europe's leading arts and design university" />
...
<!--[if (lt IE 9) & (!IEMobile)]>
    <script src='/media/beta/beta-assets/js/selectivizr-min.js'></script>
    <script src="/media/beta/beta-assets/js/html5shiv.js"></script>
    <script src ='/media/beta/beta-assets/js/respond.src.js'></script>
<![endif]-->
    
<!-- JavaScript -->
	<script type="text/javascript" src="/media/beta/beta-assets/js/modernizr-2.6.2-min.js"></script>
   	<script type="text/javascript" src="/media/beta/beta-assets/js/detectizr.min.js"></script>  
...
grunticon( [ "/media/beta/beta-assets/css/logos/logos.data.svg.css", "/media/beta/beta-assets/css/logos/logos.data.png.css", "/media/beta/beta-assets/css/logos/logos.fallback.css" ] );
  </script>
  <noscript><link href="/media/beta/beta-assets/css/logos/logos.fallback.css" rel="stylesheet"></noscript>
  </head>
...
<div class="header-panel bg-gray-bg">
    <div class="header-wrapper">
  <div class="row">
          <!-- navigation object : Breadcrumbs --><div class="breadcrumbs"><a href="/">University of the Arts London</a></div>
    <div class="page-title">
      <h1><!-- navigation object : Section name -->University of the Arts London</h1>
    </div>
  </div>  
    </div>
</div>
...
<?php } else { // close the slider ?>        
  ...
  <?php if (environment() != 'live') { ?>
    ...
    <img src="/media/beta/your-creative-journey-starts.jpg" alt="Your Creative Future Starts Here" class="rsImg" />

  <?php } else { ?>
    
    <img data-src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/your-creative-journey-starts.jpg" alt="Your Creative Future Starts Here" class="rsImg resrc" />
  <?php }
  
  $call_to_action_switch = "Study at UAL";

  if ($call_to_action_switch != "") { ?>

    <div class="call-to-action">
      <a href="/study-at-ual/" title="">Study at UAL</a>
    </div>
  ...
  <?php if (environment() != 'live') { ?>
    ...
    <img src="/media/beta/coco.jpg" alt="Coco Chanel as you've never seen her" class="rsImg" />

  <?php } else { ?>
    
    <img data-src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/coco.jpg" alt="Coco Chanel as you've never seen her" class="rsImg resrc" />
  <?php }
  
  $call_to_action_switch = "Coco Chanel as you've never seen her";

  if ($call_to_action_switch != "") { ?>

    <div class="call-to-action">
      <a href="http://newsevents.arts.ac.uk/38117/a-new-look-at-coco-chanel/" title="">Coco Chanel as you've never seen her</a>
    </div>
  ...
  <?php if (environment() != 'live') { ?>
    ...
    <img src="/media/beta/KateHowardSummerShows.jpg" alt="Best in show: tomorrow's stars, today" class="rsImg" />

  <?php } else { ?>
    
    <img data-src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/KateHowardSummerShows.jpg" alt="Best in show: tomorrow's stars, today" class="rsImg resrc" />
  <?php }
  
  $call_to_action_switch = "Best in show: tomorrow's stars, today";

  if ($call_to_action_switch != "") { ?>

    <div class="call-to-action">
      <a href="" title="">Best in show: tomorrow's stars, today</a>
    </div>
  ...
  <?php if (environment() != 'live') { ?>
    ...
    <img src="/media/beta/this-is-war.jpg" alt="This is war – Syria through the lens of a photojournalism grad" class="rsImg" />

  <?php } else { ?>
    
    <img data-src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/this-is-war.jpg" alt="This is war – Syria through the lens of a photojournalism grad" class="rsImg resrc" />
  <?php }
  
  $call_to_action_switch = "This is war";

  if ($call_to_action_switch != "") { ?>

    <div class="call-to-action">
      <a href="/study-at-ual/http://blogs.arts.ac.uk/london-college-of-communication/2013/08/28/photography-lcc-tutor-anders-birger-describes-life-on-the-syrian-border/" title="">This is war</a>
    </div>
...
<div class="panel bg-gray-bg">
	<div class="content-wrapper"> 
		<div class="row cta">
			<div class="l-content-full-width block __media two-up-full">
				<ul>
					<li>
						<figure class="feature">
                                                  <a href="" title="Open days at UAL">
                                                    <?php if (environment() != 'live') { ?>
                                                    
<img src="/media/beta/open-days.jpg" alt="Open days at UAL">
  <?php } else { ?>
  
  <img src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/open-days.jpg" alt="Open days at UAL">
    ...
    <?php } ?>
						...
						<h3><a href="" title="Open days at UAL">Open days at UAL</a></h3>
							<p>Meet our instructors, visit our studio s and see what student life is like</p>
					</li>
					<li>
						<figure class="feature">
                                                  <a href="" title="Find a course">
                                                  
                                                  <?php if (environment() != 'live') { ?>
                                                    
<img src="/media/beta/find-a-course.jpg" alt="Find a course">
  <?php } else { ?>
  
  <img src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/find-a-course.jpg" alt="Find a course">
    ...
    <?php } ?>
						...
						<h3><a href="" title="Find a course">Find a course</a></h3>
							<p>From fashion to design to fine art, look for the right course for you</p>
					</li>
				</ul>
			</div> <!-- end image-block-2-up -->
		</div> <!-- end row -->		
		<div class="row news">
			<div class="l-content-full-width block __media four-up-full">
				<ul>
					<li>
						<figure class="feature">
                                                  <a href="" title="Enrol">
...
<?php if (environment() != 'live') { ?>                                                    
                                                    ...
                                                    <img src="/media/beta/enrol.jpg" alt="Enrol">
                                                    
<?php } else { ?>

                                                      <img src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/enrol.jpg" alt="Enrol">
...
<?php } ?>                                                    
						...
						<h3><a href="" title="Enrol">Enrol</a></h3>
                                                  
                                                  
                                                  <p>Enrolment information: everything you need to know</p>
                                          
					</li>
					<li>
						<figure class="feature">
                                                  <a href="" title="Freshers' Festival">
                                                  
                                                  <?php if (environment() != 'live') { ?>                                                    
                                                    
                                                    <img src="/media/beta/freshers-festival.jpg" alt="Freshers' Festival">
                                                    
<?php } else { ?>

                                                      <img src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/freshers-festival.jpg" alt="Freshers' Festival">
...
<?php } ?>  
						...
						<h3><a href="" title="Freshers' Festival">Freshers' Festival</a></h3>
                                                  
                                                  
                                                  <p>Get Fresh: Our guide to the festivities</p>
					</li>
					<li>
						<figure class="feature">
                                                  <a href="" title="The Art of Business">
                                                  
<?php if (environment() != 'live') { ?>                                                    
                                                    
                                                    <img src="/media/beta/art-of-business.jpg" alt="The Art of Business">
                                                    
<?php } else { ?>

                                                      <img src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/art-of-business.jpg" alt="The Art of Business">
...
<?php } ?>                                                    
						...
						<h3><a href="" title="The Art of Business">The Art of Business</a></h3>
                                                  
                                                  
                                                  <p>The Art of Business</p>
					</li>
					<li>
						<figure class="feature">
                                                  <a href="" title="Spare">
...
<?php if (environment() != 'live') { ?>                                                    
                                                    ...
                                                    <img src="/media/beta/artsmart.jpg" alt="Spare">
                                                    
<?php } else { ?>

                                                      <img src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/artsmart.jpg" alt="Spare">
...
<?php } ?>                                                    
						...
						<h3><a href="" title="Spare">Spare</a></h3>
...
<div class="content-wrapper">
		<div class="row fe">
			<div class="l-content-full-width block __media four-up-full">
				<h2>Upcoming UAL Events</h2>
				<ul>

					<li>
						<figure class="feature">
                                                  <a href="http://newsevents.arts.ac.uk/" title="In conversation: Richard Wilson with curator Jane Won">
                                                    
  <?php if (environment() != 'live') { ?>                                                    
                                                    
                                                    <img src="/media/beta/EVENT1-Richard_Wilson_No__Formulas_exhibition.jpg" alt="In conversation: Richard Wilson with curator Jane Won">
                                                    
   <?php } else { ?>                                                  
                                                    
<img src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/EVENT1-Richard_Wilson_No__Formulas_exhibition.jpg" alt="In conversation: Richard Wilson with curator Jane Won">                                                    
 <?php } ?>   
                                                      
                                                      </a>
							<div class='credits'>'1513: A Ships' Opera', by Richard Wilson, 2013</div>
						</figure>
                                                    <div class="nopadding">
						<h3><a href="http://newsevents.arts.ac.uk/" title="In conversation: Richard Wilson with curator Jane Won">In conversation: Richard Wilson with curator Jane Won</a></h3>
                                                      <p>This event accompanies Chelsea Space exhibition: Richard Wilson: No Formulas</p></div>
					</li>


					<li>
						<figure class="feature">
							<a href="http://newsevents.arts.ac.uk/" title="Future Map Design">
                                                  
                                                    <?php if (environment() != 'live') { ?>                                                    
                                                    
                                                    <img src="/media/beta/EVENT2-SimonPhan_LCC_FlowerGirl_01.jpg" alt="Future Map Design">
                                                    
   <?php } else { ?>                                                  
                                                    
<img src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/EVENT2-SimonPhan_LCC_FlowerGirl_01.jpg" alt="Future Map Design">                                                    
 <?php } ?>   
                                                  
                                                  
                                                  </a>
							<div class='credits'>'Flower Girl', by Simon Phan, LCC, 2013</div>
						</figure>
                                                          <div class="nopadding">
						<h3><a href="http://newsevents.arts.ac.uk/" title="Future Map Design">Future Map Design</a></h3>
                                                            <p>An exhibition of the best design talent from UAL</p></div>
					</li>


					<li>
						<figure class="feature">
							<a href="http://newsevents.arts.ac.uk/" title="Dance Umbrella 2013">
                                                  
                                                  
  <?php if (environment() != 'live') { ?>                                                    
                                                    
                                                    <img src="/media/beta/EVENT3-Dance-Umbrella.jpg" alt="Dance Umbrella 2013">
                                                    
   <?php } else { ?>                                                  
                                                    
<img src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/EVENT3-Dance-Umbrella.jpg" alt="Dance Umbrella 2013">                                                    
 <?php } ?>                                                     
                                                          ...
                                                          <div class="nopadding">
						<h3><a href="http://newsevents.arts.ac.uk/" title="Dance Umbrella 2013">Dance Umbrella 2013</a></h3>
                                                            <p>The UK&rsquo;s most vibrant contemporary dance festival returns to the Platform Theatre</p></div>
					</li>


					<li>
						<figure class="feature">
							<a href="http://newsevents.arts.ac.uk/" title="Mirror Mirror">
                                                  
                                                  
   <?php if (environment() != 'live') { ?>                                                    
                                                    
                                                    <img src="/media/beta/EVENT4-MirrorMirror_Event-image-snapshot.jpg" alt="Mirror Mirror">
                                                    
   <?php } else { ?>                                                  
                                                    
<img src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/EVENT4-MirrorMirror_Event-image-snapshot.jpg" alt="Mirror Mirror">                                                    
 <?php } ?>                                                    
                                                  
                                                  
                                                  </a>
							<div class='credits'>'Mirror Mirror' by Ari Seth Cohen for advancedstyle.blogspot.com</div>
						</figure>
                                                          <div class="nopadding">
						<h3><a href="http://newsevents.arts.ac.uk/" title="Mirror Mirror">Mirror Mirror</a></h3>
                                                            <p>A conference exploring fresh perspectives on age and ageing in relation to culture and fashion</p></div>
					</li>
...
<div class="panel bg-gray-bg">
		...
		<div class="row st-cp">
			<div class="l-content-full-width block __media two-up-full">
				<ul>
					<li>
						<figure class="feature">
							<a href="http://showtime.arts.ac.uk/" title="Showtime">
                                                          
  <?php if (environment() != 'live') { ?>                                                        
                                                          
                                                          <img src="/media/beta/showtime.jpg" alt="Showtime">
                                                          <?php } else { ?>
                                                            
      <img src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/showtime.jpg" alt="Showtime">                                                         
                                                          
  <?php } ?>                                                         
                                                          </a>
							<div class='credits'>Vingi Wong - BA (Hons) Fashion: Fashion Print 2013</div>
						</figure>
						<h3><a href="http://showtime.arts.ac.uk/" title="Showtime">Showtime</a></h3>
							<p>Showtime is University of the Arts London's online gallery featuring up and coming artists and designers.</p>
					</li>
					<li>
						<figure class="feature">
							<a href="http://commonplace.arts.ac.uk/" title="Commonplace">
                                                    <?php if (environment() != 'live') { ?>                                                        
                                                          
                                                          <img src="/media/beta/commonplace.jpg" alt="Commonplace">
                                                          <?php } else { ?>
                                                            
      <img src="http://app.resrc.it/o=60/<?php echo siteURL(); ?>/media/beta/commonplace.jpg" alt="Commonplace">                                                         
  ...
  <?php } ?>         
							...
							<div class='credits'>Zoe Tynan-Campbell</div>
						</figure>
						<h3><a href="http://commonplace.arts.ac.uk/" title="Commonplace">Commonplace</a></h3>
							<p>Commonplace has been created to give prospective and continuing students tips and advice to support settling in to university and London life.</p>
					</li>
				</ul>
			</div>
		</div> 	
...
<footer class="row white-bg hide">
    <div class="footer-wrapper">
        ...
        <ul id="debug">
          ...
          <li>Page created : Mon 16 Sep 2013 03:29:06</li>
          <li>Page modified : Tue 17 Sep 2013 12:16:54</li>
          <?php $i = 0; ?>
...
<!--<script type="text/javascript" src="/media/beta/beta-assets/js/resrc-0.6.1.min.js"></script>-->

  <!-- fastClick -->
<script type="text/javascript" src="/media/beta/beta-assets/js/fastclick.js"></script>
...
<script type="text/javascript" src="/media/beta/beta-assets/js/jquery.review-1.0.0.min.js"></script>
...
<!-- Scripts -->
<script type="text/javascript" src="/media/beta/beta-assets/js/script.js"></script>

<!--<script type="text/javascript" src="/media/beta/beta-assets/js/script-1.js"></script>-->
